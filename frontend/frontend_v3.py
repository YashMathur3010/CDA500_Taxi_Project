...
def main():
    ...
    zone_lookup = shape_df.set_index('LocationID')['zone'].to_dict()
    predictions['zone_name'] = predictions['pickup_location_id'].map(zone_lookup)

    # Display Top 10 Locations with Name
